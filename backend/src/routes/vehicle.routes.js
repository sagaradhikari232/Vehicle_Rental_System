...
import { registerVehicle, getAllVehicles, getVehicleById, updateVehicle, deleteVehicle,getRecommendedVehicles} from "../controllers/vehicle.controller.js";
...
router.route("/similar").get(verifyJWT,getRecommendedVehicles)
